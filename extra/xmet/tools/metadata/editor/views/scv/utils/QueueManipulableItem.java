...
/**
 * List class for maintaining a list of manipulable items with the same name but
 * only the first item gets manipulated.
 * @author Nahid Akbar
 */
public class QueueManipulableItem
    ...
    public String getValue() {
        for (final NamedItem item : this) {
            if (item instanceof ContentNamedItem) {
                return ((ContentNamedItem) item).getValue();
            }
        }
        return null;
    }
