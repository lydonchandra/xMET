...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
    ...
    <!-- 
        ...
        USA.
    -->
    <sch:title>Check that the codeList exists and that the codeListValue is in
        that codeList</sch:title>
    ...
    <sch:pattern id="checkCodeList">
        <sch:rule context="//*[@codeList]">
            ...
            <sch:assert test="@codeListValue = $codeListDoc/gmx:codeEntry/gmx:CodeDefinition/gml:identifier">codeListValue "<sch:value-of select="@codeListValue" />" is not in the specified codeList <sch:value-of select="@codeList" />.</sch:assert>
        </sch:rule>
    </sch:pattern>
</sch:schema>
