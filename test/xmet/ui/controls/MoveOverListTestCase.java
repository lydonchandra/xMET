 ...
 * @author Nahid Akbar
 */
public class MoveOverListTestCase
    extends AbstractGUIObjectTestCase {

    /**
     * Instantiates a new move over list test case.
     */
    public MoveOverListTestCase() {
        super(MoveOverList.class);
    }
    ...
    protected void setUp()
        throws Exception {
        super.setUp();
        ((MoveOverList) getInstance()).setCustomList("asdf");
    }
