...
/**
 * Test case for CodelistCatalogList control.
 * @author Nahid Akbar
 */
public class CodelistCatalogListTestCase
    extends AbstractGUIObjectTestCase {

    /**
     * Instantiates a new codelist catalog list test case.
     */
    public CodelistCatalogListTestCase() {
        super(CodelistCatalogList.class);
    }
    ...
    protected void setUp()
        throws Exception {
        super.setUp();
        ((CodelistCatalogList) getInstance()).getList().setCustomList(
            "asdf");
    }
